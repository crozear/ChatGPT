...
export default function App(){
  ...
  if (s.cond.control >= 60) s.cond.stress = L5.clamp(s.cond.stress - 1, 0, 200);s=L5.dryClothes(s);setB((prev:any)=>({...prev,wet:s.wet,conditions:s.cond,clothing:s.clothing}))},[b,turn,coreVal,hasP]);
